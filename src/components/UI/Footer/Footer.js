...
import BLink from '../../UI/Link/Link';
          ...
          <div className='col-sm-6 col-md-6 col-lg-3 mb-5'>
            ...
            <div className='footer-content'>
              <p className='text-muted'>
                <small>Address : Wings Office Complex, 17A, Ozumba Mbadiwe Avenue, Victoria Island, Lagos, Nigeria </small>
              </p>
              <p className='text-muted'>
                <small>Phone : +2349053055125, +2348060887527</small>
              </p>
              <p className='text-muted'>
                <small>E-mail : techplugs@gmail.com</small>
              </p>
